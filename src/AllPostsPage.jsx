    ...
    <div className="min-h-screen bg-night text-slate-300">
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <header className="mt-12">
          <h1 className="text-3xl font-semibold text-white">All Posts</h1>
          <p className="mt-3 text-slate-400">
            Projects, experiments, and things I've worked on.
          </p>
        </header>
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <h2 className="text-white font-medium group-hover:text-slate-100">
                    {post.title}
                  </h2>
